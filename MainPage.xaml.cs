...
public partial class MainPage : ContentPage
{
    ...
    private async void ClearOldHistory(object sender, EventArgs e)
    {
        await Calculator.historyViewModel.DeleteHistory();
   ...
   async void  OnCalculate(object sender, EventArgs e)
    {
        if (currentState == 2)
        {
            ...
            double result = Convert.ToDouble(await Calculator.Calculate(firstNumber, secondNumber, mathOperator));
