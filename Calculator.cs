...
public static class Calculator
{
    ...
    public static HistoryViewModel historyViewModel = new HistoryViewModel(MauiProgram.dbPath);
   
    public  static async Task<double>  Calculate(double value1, double value2, string mathOperator)
    {
        double result = 0;
        switch (mathOperator)
        {
        ...
        await historyViewModel.AddToHistory(question+" = "+result.ToString());
